...
export type TaskResponse = { taskId: string; taskType: string; sourceUri: string; documentId: string; versionId: string; status: string; step: string; retryCount: number; errorMessage: string | null; createdAt: string | null; startedAt: string | null; finishedAt: string | null; };
